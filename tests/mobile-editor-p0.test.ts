...
const chatInput = read('components/chat/mobile-chat-input.tsx')
assert.match(chatInput, /describeAttachment/)
assert.match(chatInput, /URL\.createObjectURL/)
assert.match(chatInput, /URL\.revokeObjectURL/)
assert.doesNotMatch(chatInput, /Use this image reference:|Use this video reference:/)
