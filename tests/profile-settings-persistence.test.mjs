...
assert.match(avatarRoute, /\[R2\] Upload request/)
assert.match(avatarRoute, /\[R2\] Upload response/)
assert.match(avatarRoute, /R2 upload failed/)
assert.match(settings, /no persisted URL was returned/)
assert.doesNotMatch(settings, /updatedProfile\?\.avatar_url \|\| optimisticPreviewUrl/)
